                                        ...
                                        for (var token in grammar) {
                                            ...
                                            for (var j = 0; j < patterns.length; ++j) {
                                                ...
                                                var patternObj = patterns[j], inside = patternObj.inside,
                                                    ...
                                                    lookbehindLength = 0, alias = patternObj.alias;
                                                ...
                                                for (var currentNode = startNode.next, pos = startPos; currentNode !== tokenList.tail; pos += currentNode.value.length, currentNode = currentNode.next) {
                                                    ...
                                                    var from = match.index + lookbehindLength,
                                                        ...
                                                        to = from + matchStr.length, before = str.slice(0, from),
                                                        after = str.slice(to);
                                    ...
                                    if (!_self.document) {
                                        ...
                                        if (!_.disableWorkerMessageHandler) {
                                            _self.addEventListener('message', function (evt) {
                                                var message = JSON.parse(evt.data), lang = message.language,
                                                    code = message.code, immediateClose = message.immediateClose;
