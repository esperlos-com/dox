...
$(document).ready(function () {
  window.addEventListener('pop-alert', function (event) {
  ...
  _createClass(Toaster, null, [{
    ...
    value: function fire() {
      ...
      if (self.canClick) {
        ...
        var interval = setInterval(start, duration * 1000);
      }
    }
  }]);
  return Toaster;
}();
_defineProperty(Toaster, "canClick", true);
