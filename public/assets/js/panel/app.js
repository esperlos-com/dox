...
(function ($) {
  ...
  $(document).on('click', '*', function (e) {
    if (!$(e.target).is('.sidebar, .sidebar *, .sidebar-open, .sidebar-open *') && $('.sidebar').hasClass('show') || !$(e.target).is('.search-panel-open, .search-panel-open *, nav.navbar .header-body form.search, nav.navbar .header-body form.search *') && $('nav.navbar .header-body form.search').hasClass('show') || !$(e.target).is('.side-menu-open, .side-menu-open *, .side-menu, .side-menu *') && $('.side-menu').hasClass('show')) {
  ...
  $(document).on('click', '.search-panel-open', function () {
    $('nav.navbar form.search').addClass('show').find('input:first').focus();
    $.createOverlay();
    return false;
  });
  /*------------- mobile search panel open -------------*/
  ...
  function initCustomScrollbar(type) {
    ...
    if (type == 'resize') {
      ...
      if (!body_.hasClass('horizontal-side-menu') && wind_.width() >= 992 || body_.hasClass('horizontal-side-menu') && wind_.width() < 992) {
        if (wind_.width() >= 768) {
  ...
  if ((typeof CKEDITOR === "undefined" ? "undefined" : _typeof(CKEDITOR)) == 'object' && $('body').hasClass('dark')) {
